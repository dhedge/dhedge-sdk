...
;(async () => {
    ...
    console.log(
        'isPool',
        pool.getAddress(),
        await factory.isPool(pool.getAddress())
    )
    console.log(
        'isPool',
        '0xb12DC0644f505028388Da4A919eD72d422175dA8',
        await factory.isPool('0xb12DC0644f505028388Da4A919eD72d422175dA8')
    )
    console.log(
        'Pool manager fee',
        await factory.getManagerFee(pool.getAddress())
    )
