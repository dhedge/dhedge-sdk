module.exports = [
    ...
    {
        inputs: [],
        name: 'getManagerFeeNumeratorChangeDelay',
        outputs: [
            {
                internalType: 'uint256',
                name: '',
    ...
    {
        inputs: [],
        name: 'getMaximumManagerFeeNumeratorChange',
        outputs: [
            {
                internalType: 'uint256',
                name: '',
    ...
    },
    {
        inputs: [
            {
                internalType: 'address',
                name: 'dhptSwapAddress',
                type: 'address',
            },
        ],
        name: 'setDhptSwapAddress',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
